            ...
            template:
                '<div id="cardio-wrapper" class = "cardio-widget">' +
                    '<table style="font-family: verdana; font-size: 12px">' +
                        ...
                        '</tr>' +
                        '<tr>' +
                            '<td> Seios Aórticos (Raiz da Aorta):</td>' +
                        ...
                        '<tr>' +
                            ...
                            '<td><div id="aasc" class="edt single-line editable7" tabindex="4" style="width: 45px;height: 18px;overflow: hidden;"> </div> </td>' +
                            '<td> mm</td>' +
                            '<td style = "padding-left: 20px"><div style = "min-width: 40px; height: 18px" id = "refaa" class="editable8 edt refeditable"></div> </td>' +
                        '</tr>' +

                        '<tr>' +
                            '<td> Arco Aórtico (Aorta Transversa):</td>' +
                            '<td><div id="jsn" class="edt single-line editable5" tabindex="5" style="width: 45px;height: 18px;overflow: hidden;"> </div> </td>' +
                            '<td> mm</td>' +
                            '<td  style = "padding-left: 20px"><div style = "min-width: 40px; height: 18px" id = "refat" class="editable6 edt refeditable"></div> </td>' +
                        '</tr>' +
